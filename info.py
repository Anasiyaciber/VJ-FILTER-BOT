...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002763441507 -1001215323187 -1001881821580').split()]  # For Multiple Id Use One Space Between Each.
